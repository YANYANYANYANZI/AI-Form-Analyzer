...
输入提示词：
    ...
    “查一下咱们内部知识库，关于环保数据清洗的红线要求和图表配色规范分别是什么？不要写代码。”
...
输入提示词：
    ...
    “提取 2023 年的数据，帮我严格按照集团的可视化规范，画一个绿色发展指数排名前 10 的柱状图。并且在总结里告诉我，有没有需要触发预警的省份？”
...
输入提示词：
    ...
    “上面这个图里排名前三的省份，你觉得哪个地方的美食最好吃？咱们随便聊聊，不要处理数据了。”
...
输入提示词：
    ...
    “现在我正式授权你生成模拟数据：假设在纳西妲的管理下，北京 2024 年工业排放量统一降低 30%（基于它们2023年的排放量）。请你生成这 北京 的模拟数据，并画图对比一下 2023 与 2024 的排放量。”
